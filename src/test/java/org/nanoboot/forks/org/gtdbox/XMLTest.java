...
public class XMLTest extends TestCase {
	...
	public void testParserEncoding() {
		...
		try {
			...
			File file= new File("./src/test/resources/gtd-box-data_2.1.xml");
			...
			file= new File("./src/test/resources/gtd-box-data_WIN1250_2.1.xml");
			...
			file= new File("./src/test/resources/gtd-box-data_2.1_enc.xml");
			is= new FileInputStream(file);
			r= XMLInputFactory.newInstance().createXMLStreamReader(is);
			System.out.println(r.getEncoding());
			assertEquals("UTF-8", r.getEncoding());
			...
			file= new File("./src/test/resources/gtd-box-data_WIN1250_2.1_enc.xml");
			is= new FileInputStream(file);
			r= XMLInputFactory.newInstance().createXMLStreamReader(is);
			System.out.println(r.getEncoding());
