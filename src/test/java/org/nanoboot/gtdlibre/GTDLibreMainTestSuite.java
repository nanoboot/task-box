 ...
 * @author ikesan
 */
public class GTDLibreMainTestSuite extends TestSuite {
    public GTDLibreMainTestSuite() {
        addTestSuite(GTDLibreMainEngineTest.class);
        addTestSuite(ModelTest.class);
        addTestSuite(SaveLoadTest.class);
    }

    public static Test suite() {
        return new GTDLibreMainTestSuite();
    }
}
