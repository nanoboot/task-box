...
public class ModelTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        URL url = new URL("http://task-libre.sourceforge.net/");
        a1.setUrl(url);
    ...
    public void testLoadWIN1250() {
        File f = new File(testDir, "task-libre-data_WIN1250_2.1.xml");
        File f1 = new File(testDir, "task-libre-data1.xml");
    ...
    public void testLoadVsImport() {
        try {
            ...
            File f = new File(testDir, "task-libre-data.xml");
    ...
    public void testSaveLoad() {
        File f = new File(testDir, "task-libre-data-s.xml");
    ...
    public void test21vs20() {
        File f = new File(testDir, "task-libre-data_2.0.xml");
