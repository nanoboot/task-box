...
import org.nanoboot.gtdlibre.GlobalProperties;
...
import org.nanoboot.gtdlibre.model.FolderListener;
import org.nanoboot.gtdlibre.model.Priority;
...
public class ActionPanel extends JPanel implements FolderListener {
    ...
    private void initialize(boolean packHorizontal) {
         ...
         */
        JLabel jl =
                new JLabel(Messages.getString("ActionPanel.ID")); //$NON-NLS-1$
        if (packHorizontal) {
            add(jl, new GridBagConstraints(0, row, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p = new JPanel();
            p.setLayout(new GridBagLayout());
            p.add(jl, new GridBagConstraints(0, 0, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        }

        idLabel =
                new JLabel(Messages.getString("ActionPanel.NA")); //$NON-NLS-1$
        Dimension d = new Dimension(100, 21);
        idLabel.setPreferredSize(d);
        idLabel.setMinimumSize(d);
        if (packHorizontal) {
            add(idLabel, new GridBagConstraints(1, row, 2, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p.add(idLabel, new GridBagConstraints(1, 0, 1, 1, 1, 0,
         ...
         */
        jl = new JLabel(
                Messages.getString("ActionPanel.Created")); //$NON-NLS-1$
        if (packHorizontal) {
            add(jl, new GridBagConstraints(0, ++row, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p.add(jl, new GridBagConstraints(2, 0, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        if (packHorizontal) {
            add(createdLabel, new GridBagConstraints(1, row, 2, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p.add(createdLabel, new GridBagConstraints(3, 0, 1, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        if (packHorizontal) {
            ...
            p.add(jl, new GridBagConstraints(4, 0, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        if (packHorizontal) {
            add(folderLabel, new GridBagConstraints(1, row, 2, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p.add(folderLabel, new GridBagConstraints(5, 0, 1, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
            add(p, new GridBagConstraints(0, row, 2, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        ...
        descText.getInputMap().put(KeyStroke
        ...
        if (packHorizontal) {
            add(descTextScroll, new GridBagConstraints(0, ++row, 3, 1, 1, 1,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(1, 1, 1, 1), 0, 17));
        } else {
            add(descTextScroll, new GridBagConstraints(0, ++row, 2, 1, 1, 1,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(1, 1, 1, 1), 0, 17));
        }
        ...
        if (packHorizontal) {
            add(jl, new GridBagConstraints(0, ++row, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0)); //$NON-NLS-1$
        }
        ...
        if (packHorizontal) {
            add(urlText, new GridBagConstraints(1, row, 1, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        if (packHorizontal) {
            add(b, new GridBagConstraints(2, row, 1, 1, 0, 0,
            ...
            p.add(jl, new GridBagConstraints(0, 0, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0)); //$NON-NLS-1$
            p.add(urlText, new GridBagConstraints(1, 0, 1, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
            p.add(b, new GridBagConstraints(2, 0, 1, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.NONE,
                    new Insets(1, 1, 1, 1), 0, 0));
            add(p, new GridBagConstraints(0, ++row, 2, 1, 0, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        if (packHorizontal) {
            add(projectCombo, new GridBagConstraints(1, row, 2, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.NONE,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p.add(projectCombo, new GridBagConstraints(1, 0, 1, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.NONE,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
         ...
         */
        if (packHorizontal) {
            add(new JLabel(Messages.getString("ActionPanel.Reminder")),
                    new GridBagConstraints(0, ++row, 1, 1, 0, 0,
                            GridBagConstraints.CENTER, GridBagConstraints.NONE,
                            new Insets(1, 1, 1, 1), 0, 0)); //$NON-NLS-1$
        } else {
            p.add(new JLabel(Messages.getString("ActionPanel.Reminder")),
...
*/
        ...
        pp.add(datePicker, new GridBagConstraints(0, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        ...
        previousDayButton.setIcon(ApplicationHelper
                .getIcon(ApplicationHelper.icon_name_small_previous));
        ...
        pp.add(previousDayButton, new GridBagConstraints(1, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        ...
        nextDayButton.setIcon(ApplicationHelper
        ...
        pp.add(nextDayButton, new GridBagConstraints(2, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));
        ...
        clearDateButton.setIcon(ApplicationHelper
                .getIcon(ApplicationHelper.icon_name_small_clear));
        clearDateButton.addActionListener(e -> datePicker.setDate(null));
        pp.add(clearDateButton, new GridBagConstraints(3, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(0, 0, 0, 0), 0, 0));

        if (packHorizontal) {
            add(pp, new GridBagConstraints(1, row, 2, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.NONE,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            p.add(pp, new GridBagConstraints(3, 0, 1, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.NONE,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        if (packHorizontal) {
            add(priorityPanel, new GridBagConstraints(1, row, 2, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.NONE,
                    new Insets(4, 1, 4, 1), 0, 0));
        } else {
            p.add(priorityPanel, new GridBagConstraints(5, 0, 1, 1, 1, 0,
                    GridBagConstraints.WEST, GridBagConstraints.NONE,
                    new Insets(4, 1, 4, 1), 0, 0));
            add(p, new GridBagConstraints(0, ++row, 2, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL,
        ...
        jp.add(new JLabel("Go to:"),
                new GridBagConstraints(buttonIndex++, 0, 1, 1, 1, 0,
                        GridBagConstraints.EAST, GridBagConstraints.NONE,
                        new Insets(1, 1, 1, 4), 0, 0));
        ...
        jp.add(selectPreviousButton,
                new GridBagConstraints(buttonIndex++, 0, 1, 1, 0, 0,
                        GridBagConstraints.CENTER, GridBagConstraints.NONE,
                        new Insets(1, 1, 1, 1), 0, 0));
        ...
        jp.add(selectNextButton,
                new GridBagConstraints(buttonIndex++, 0, 1, 1, 1, 0,
                        GridBagConstraints.WEST, GridBagConstraints.NONE,
                        new Insets(1, 1, 1, 1), 0, 0));

        jp.add(new JLabel("Move:"),
                new GridBagConstraints(buttonIndex++, 0, 1, 1, 1, 0,
                        GridBagConstraints.EAST, GridBagConstraints.NONE,
        ...
        if (packHorizontal) {
            add(jp, new GridBagConstraints(0, ++row, 3, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            add(jp, new GridBagConstraints(0, ++row, 1, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
        ...
        queueActionButton.setIcon(ApplicationHelper
                .getIcon(ApplicationHelper.icon_name_large_queue_off));
        queueActionButton.setSelectedIcon(ApplicationHelper
                .getIcon(ApplicationHelper.icon_name_large_queue_on));
        queueActionButton.setDisabledSelectedIcon(ApplicationHelper
                .getIcon(ApplicationHelper.icon_name_large_queue_off));
        buttonsPanel.add(queueActionButton,
                new GridBagConstraints(buttonIndex++, 0, 1, 1, 0, 0,
                        GridBagConstraints.CENTER, GridBagConstraints.NONE,
                        new Insets(1, 1, 1, 1), 0, 0));
        ...
        buttonsPanel.add(b, new GridBagConstraints(buttonIndex++, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(1, 1, 1, 1), 0, 0));
        //jp.add(b);
        ...
        if (packHorizontal) {
            add(buttonsPanel, new GridBagConstraints(0, ++row, 3, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(1, 1, 1, 1), 0, 0));
        } else {
            add(buttonsPanel, new GridBagConstraints(1, row, 1, 1, 1, 0,
                    GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                    new Insets(1, 1, 1, 1), 0, 0));
        }
    ...
    public Dimension getPreferredSize() {
        return new Dimension(buttonsPanel.getPreferredSize().width,
                super.getPreferredSize().height);
    }

    @Override
    public Dimension getMinimumSize() {
        return new Dimension(buttonsPanel.getMinimumSize().width,
                super.getMinimumSize().height);
    }

    private javax.swing.Action getOpenURLAction() {
        if (openURLAction == null) {
            openURLAction = new AbstractAction(ApplicationHelper.EMPTY_STRING,
                    ApplicationHelper.getIcon(
                            ApplicationHelper.icon_name_large_browser)) {
                private static final long serialVersionUID = 1L;
                ...
                public void actionPerformed(ActionEvent e) {
                    if (action != null && action.getUrl() != null) {
                        try {
                            Desktop.getDesktop()
                                    .browse(action.getUrl().toURI());
                        } catch (Exception e1) {
                            e1.printStackTrace();
                            JOptionPane.showConfirmDialog(ActionPanel.this,
                                    Messages.getString(
                                            "ActionPanel.LinkError.1") + action
                                            .getUrl() + Messages.getString(
                                            "ActionPanel.LinkError.2") + e1
                                            .getMessage(), Messages.getString(
                                            "ActionPanel.LinkError.Title"),
                                    JOptionPane.OK_OPTION,
                                    JOptionPane.ERROR_MESSAGE); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
                        }
                    }
                }

            };
            openURLAction.putValue(AbstractAction.SHORT_DESCRIPTION,
                    Messages.getString("open.Tooltip")); //$NON-NLS-1$
    ...
    private javax.swing.Action getDeleteAction() {
        if (deleteAction == null) {
            deleteAction = new AbstractAction(Messages.getString("delete"),
                    ApplicationHelper.getIcon(
                            ApplicationHelper.icon_name_large_delete)) { //$NON-NLS-1$
                private static final long serialVersionUID = 1L;
            ...
            deleteAction.putValue(AbstractAction.SHORT_DESCRIPTION,
                    Messages.getString("delete.Tooltip")); //$NON-NLS-1$
    ...
    private javax.swing.Action getResolveAction() {
        if (resolveAction == null) {
            resolveAction = new AbstractAction(Messages.getString("resolve"),
                    ApplicationHelper.getIcon(
                            ApplicationHelper.icon_name_large_resolve)) { //$NON-NLS-1$
                private static final long serialVersionUID = 1L;
            ...
            resolveAction.putValue(AbstractAction.SHORT_DESCRIPTION,
                    Messages.getString("resolve.Tooltip")); //$NON-NLS-1$
    ...
    private javax.swing.Action getQueuedAction() {
        if (queuedAction == null) {
            queuedAction = new AbstractAction(
                    Messages.getString("queue")) { //$NON-NLS-1$
                private static final long serialVersionUID = 1L;
            ...
            queuedAction.putValue(AbstractAction.SHORT_DESCRIPTION,
                    Messages.getString("queue.Tooltip")); //$NON-NLS-1$
    ...
    private javax.swing.Action getReopenAction() {
        if (reopenAction == null) {
            reopenAction = new AbstractAction(Messages.getString("reopen"),
                    ApplicationHelper.getIcon(
                            ApplicationHelper.icon_name_large_undelete)) { //$NON-NLS-1$
                private static final long serialVersionUID = 1L;
            ...
            reopenAction.putValue(AbstractAction.SHORT_DESCRIPTION,
                    Messages.getString("reopen.Tooltip")); //$NON-NLS-1$
    ...
    public void setEnabled(boolean enabled) {
        ...
        getReopenAction()
                .setEnabled(enabled && (action != null && !action.isOpen()));
        getResolveAction()
                .setEnabled(enabled && (action != null && action.isOpen()));
        getDeleteAction()
                .setEnabled(enabled && (action != null && action.isOpen()));
        getQueuedAction()
                .setEnabled(enabled && (action != null && action.isOpen()));
        getOpenURLAction().setEnabled(
                enabled && (action != null && action.getUrl() != null));
    ...
    private void updateGUI() {
        ...
        getOpenURLAction()
                .setEnabled(action != null && action.getUrl() != null);
        if (a == null) {
            idLabel.setText(Messages.getString("ActionPanel.NA")); //$NON-NLS-1$
            createdLabel.setText(
                    Messages.getString("ActionPanel.NA")); //$NON-NLS-1$
            folderLabel.setText(
                    Messages.getString("ActionPanel.NA")); //$NON-NLS-1$
            ...
            idLabel.setText(s);
            s = ApplicationHelper
                    .toISODateTimeString(a.getCreated()); //$NON-NLS-1$
            ...
            if (!setting) {
                ...
                s = a.getDescription() == null ?
                        ApplicationHelper.EMPTY_STRING :
                        a.getDescription(); //$NON-NLS-1$
                ...
                if (a.getUrl() != null) {
                    ...
                    urlText.setText(
                            ApplicationHelper.EMPTY_STRING); //$NON-NLS-1$
                }
                if (a.getRemind() != null) {
                ...
                if (action.getProject() != null) {
                    projectCombo.setSelectedProject(
                            action.getFolder().getParent()
    ...
    public void elementModified(
            org.nanoboot.gtdlibre.model.ActionEvent note) {
     ...
     */
    public void setEngine(GTDLibreEngine e) {
        this.engine = e;
        ...
        engine.getGlobalProperties()
                .addPropertyChangeListener(GlobalProperties.SHOW_ALL_ACTIONS,
                        evt -> reopenButton.setVisible(
                                engine.getGlobalProperties().getBoolean(
                                        GlobalProperties.SHOW_ALL_ACTIONS)));
        reopenButton.setVisible(
                reopenButtonVisible || engine.getGlobalProperties()
    ...
    public void setDescriptionTextMinimumHeight(int min) {
        descTextScroll.setMinimumSize(
                new Dimension(descTextScroll.getMinimumSize().width, min));
    }
    ...
    public void putActions(ActionMap actions) {
        ...
        selectPreviousButton
                .setAction(actions.get(ActionTable.SELECT_PREVIOUS));
    }
