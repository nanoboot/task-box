...
import org.nanoboot.forks.org.taskbox.gui.ExecutePane;
import org.nanoboot.forks.org.taskbox.gui.ImportExampleDialog;
import org.nanoboot.forks.org.taskbox.gui.InBasketPane;
import org.nanoboot.forks.org.taskbox.gui.JournalPane;
import org.nanoboot.forks.org.taskbox.gui.OrganizePane;
import org.nanoboot.forks.org.taskbox.gui.ProcessPane;
import org.nanoboot.forks.org.taskbox.gui.QuickCollectPanel;
...
import org.nanoboot.forks.org.taskbox.model.Utils;
...
public class GTDBoxMain {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println("java -jar task-box.jar [-data <folder>]");
        //                           1         2         3         4         5         6         7         8
        ...
        if (!ApplicationHelper.tryLock(f)) {
            System.out
                    .println("Instance of Task-Box already running, exiting.");
            System.exit(0);
        }
    ...
    private JFrame getJFrame() {
        if (jFrame == null) {
            ...
            jFrame.setTitle("Task-Box" + windowTitleSuffix);
...
/*	private void restoreState() {
    ...
    private Component getOverviewPane() {
        if (overview == null) {
            ...
            sl = new SummaryLabel("mainCounts") {
                ...
                @Override
                public void actionPerformed(ActionEvent e) {
                    GTDBoxMain.this.getActionMap().get("importDialog")
                            .actionPerformed(e);
    ...
    private JDialog getAboutDialog() {
        if (aboutDialog == null) {
            ...
            aboutDialog.setTitle("About Task-Box");
            ...
            JLabel jl = new JLabel("Task-Box", ii, SwingConstants.CENTER);
    ...
    private JFileChooser getFileChooser() {
        if (fileChooser == null) {
            ...
            fileChooser.setFileFilter(
                    new FileNameExtensionFilter("Task-Box XML file", "xml"));
        }
        return fileChooser;
    }
    ...
    class SummaryBean implements GTDModelListener {
        ...
        public void elementModified(
            ...
            if (a.getAction().getFolder().isQueue() || a.getAction()
                ...
                updateInBucket();
                               ...
                               .equals(org.nanoboot.forks.org.taskbox.model.Action.REMIND_PROPERTY_NAME)
                       || (a.getAction().getRemind() != null && a.getProperty()
                    .equals(org.nanoboot.forks.org.taskbox.model.Action.RESOLUTION_PROPERTY_NAME))) {
                updateReminders();
            }
        }
        ...
        private void updateReminders() {
            ...
            for (org.nanoboot.forks.org.taskbox.model.Action a : getEngine()
