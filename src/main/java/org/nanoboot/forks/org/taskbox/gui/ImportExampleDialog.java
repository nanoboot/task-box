...
public class ImportExampleDialog {
    ...
    public JDialog getDialog(final Frame owner) {
        if (dialog == null) {
            ...
            JLabel l = new JLabel(
                    "Import Task-Box database file with demo list and some helpful actions.");
            ...
            l = new JLabel(
                    "Download and import latest examples from Task-Box web site.");
    ...
    class ImportThread extends Thread {
        ...
        private void importExample(boolean server)
            ...
            if (server) {
                monitor.setNote(
                        "Contacting http://task-box.sourceforge.net/...");
