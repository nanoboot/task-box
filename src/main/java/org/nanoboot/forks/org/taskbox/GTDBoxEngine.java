...
import org.nanoboot.forks.org.taskbox.gui.StateMachine;
import org.nanoboot.forks.org.taskbox.journal.JournalModel;
...
public class GTDBoxEngine {
    ...
    public GTDBoxEngine() throws FileNotFoundException, XMLStreamException,
    ...
    private boolean handleFailedLoad(GTDModel m, GTDModel.DataHeader[] dh,
        ...
        if (dh == null || dh.length <= i) {
            ...
            int option = JOptionPane.showConfirmDialog(
                    null,
                    "Your data was NOT properly loaded into the Task-Box because of file loading error: \n\""
                    +
                    e.toString().replace(". ", ".\n") +
                    ...
                    "\ntask-box-data.backupN.xml where 'N' stands for numbers from 0 to 9.",
                    "Task-Box - Error Loading Data File",
