...
import org.nanoboot.forks.org.gtdbox.model.Action.Resolution;
...
public class Folder implements Iterable<Action> {
	...
	public void fireElementModified(Action a, String property, Object oldVal, Object newVal) {
		fireElementModified(a,property,oldVal,newVal,false);
	}

	public void fireElementModified(Action a, String property, Object oldVal, Object newVal, boolean recycled) {
		if ((oldVal==null && newVal==null) || (oldVal!=null && oldVal.equals(newVal))) {
			return;
		}
		fireElementModified(new ActionEvent(this,a,property,oldVal,newVal,recycled));
	}
	...
	public boolean isBuildIn() {
		return type==FolderType.BUILDIN || type==FolderType.BUILDIN_REMIND || type==FolderType.BUILDIN_RESOLVED || type==FolderType.BUILDIN_DELETED || type==FolderType.BUILDIN_PRIORITY;
	}
	...
	public boolean isUserFolder() {
		return type==FolderType.ACTION || type==FolderType.REFERENCE || type==FolderType.SOMEDAY;
	}
	...
	public void setDescription(String d) {
		if ((description !=null && description.equals(d)) || (description==null && d==null)) {
			return;
		}
