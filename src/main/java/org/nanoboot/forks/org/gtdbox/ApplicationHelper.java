...
public final class ApplicationHelper {
	...
	public static final String DATA_PROPERTY= "gtd-box.data";
	public static final String LOCK_FILE_NAME= "gtd-box.lock";
	public static final String DEFAULT_DATA_FILE_NAME= "gtd-box-data.xml";
	public static final String SHUTDOWN_EMERGENCY_BACKUP_DATA_FILE_NAME= "gtd-box-data.shutdown_backup.xml";
	public static final String BACKUP_DATA_FILE_NAME_PART= "gtd-box-data.backup";
	public static final String DEFAULT_DATA_FOLDER_NAME= ".gtd-box";
	public static final String CONFIGURATION_FILE_NAME=
			"gtd-box-config.properties";
	public static final String OPTIONS_FILE_NAME="gtd-box-options.properties";
