...
import org.nanoboot.tasklibre.gui.ExecutePane;
import org.nanoboot.tasklibre.gui.ImportExampleDialog;
import org.nanoboot.tasklibre.gui.InBasketPane;
import org.nanoboot.tasklibre.gui.JournalPane;
import org.nanoboot.tasklibre.gui.OrganizePane;
import org.nanoboot.tasklibre.gui.ProcessPane;
import org.nanoboot.tasklibre.gui.QuickCollectPanel;
import org.nanoboot.tasklibre.model.ConsistencyException;
import org.nanoboot.tasklibre.model.Folder;
import org.nanoboot.tasklibre.model.FolderEvent;
import org.nanoboot.tasklibre.model.GTDModel;
import org.nanoboot.tasklibre.model.GTDModelListener;
import org.nanoboot.tasklibre.model.Utils;
...
public class TaskLibreMain {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println("java -jar task-libre.jar [-data <folder>]");
        //                           1         2         3         4         5         6         7         8
        ...
        try {
            final TaskLibreMain application = new TaskLibreMain();
...
/*	private void restoreState() {
    ...
    private Component getOverviewPane() {
        if (overview == null) {
            ...
            sl = new SummaryLabel("mainCounts") {
                ...
                @Override
                public void actionPerformed(ActionEvent e) {
                    TaskLibreMain.this.getActionMap().get("importDialog")
                            .actionPerformed(e);
                ...
                try {
                    uri = new URI(getEngine().getConfiguration()
                            .getProperty("application.home.url",
                                    "http://task-libre.sourceforge.net"));
    ...
    class SummaryBean implements GTDModelListener {
        ...
        public void elementModified(
                org.nanoboot.tasklibre.model.ActionEvent a) {
            if (a.getAction().getFolder().isQueue() || a.getAction()
                ...
                updateInBucket();
                               ...
                               .equals(org.nanoboot.tasklibre.model.Action.REMIND_PROPERTY_NAME)
                       || (a.getAction().getRemind() != null && a.getProperty()
                    .equals(org.nanoboot.tasklibre.model.Action.RESOLUTION_PROPERTY_NAME))) {
                updateReminders();
            }
        }
        ...
        private void updateReminders() {
            ...
            for (org.nanoboot.tasklibre.model.Action a : getEngine()
