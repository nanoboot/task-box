...
public class ProcessPane extends JSplitPane {
    ...
    private void initialize() {
        ...
        jpp.add(actionSpinner, new GridBagConstraints(0, 0, 3, 1, 1, 1,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(4, 4, 0, 4), 0, 0));
        //jpp.setMinimumSize(new Dimension(100,actionSpinner.getRowHeight()+41));

        leftLabel = new JLabel();
        jpp.add(leftLabel, new GridBagConstraints(0, 1, 1, 1, 1, 0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(4, 4, 4, 4), 0, 0));

        JButton b = new JButton(getResolveAction());
        jpp.add(b, new GridBagConstraints(0, 1, 1, 1, 1, 0,
                GridBagConstraints.EAST, GridBagConstraints.NONE,
                new Insets(4, 4, 4, 4), 0, 0));

        b = new JButton(getDeleteAction());
        jpp.add(b, new GridBagConstraints(1, 1, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.NONE,
                new Insets(4, 4, 4, 4), 0, 0));

        b = new JButton(getMoveAction());
        jpp.add(b, new GridBagConstraints(2, 1, 1, 1, 1, 0,
                GridBagConstraints.WEST, GridBagConstraints.NONE,
                new Insets(4, 4, 4, 4), 0, 0));

        jp.add(jpp, new GridBagConstraints(0, 0, 3, 1, 1, 1,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
                new Insets(4, 4, 0, 4), 0, 0));
        ...
        folders.addPropertyChangeListener("selectedFolder", evt -> {
            ...
            getMoveAction().setEnabled(actionSpinner.getSelectedAction() != null
                                       && folders.getSelectedFolder() != null);
        });
        ...
        jp.add(actionPanel, new GridBagConstraints(0, 0, 1, 1, 0, 0,
                GridBagConstraints.CENTER, GridBagConstraints.BOTH,
    ...
    public void packLayout() {
        setDividerLocation(
                (int) ((JSplitPane) getRightComponent()).getLeftComponent()
                        .getMinimumSize().getHeight() + 68);
    }

    private Action getMoveAction() {
        if (moveAction == null) {
            moveAction = new AbstractAction("Move to Selected List",
                    ApplicationHelper
                            .getIcon(ApplicationHelper.icon_name_large_move)) {
                private static final long serialVersionUID =
                        -8908528493980828208L;

                public void actionPerformed(ActionEvent e) {
                    org.nanoboot.tasklibre.model.Action n =
                            actionSpinner.getSelectedAction();
    ...
    private Action getDeleteAction() {
        if (deleteAction == null) {
            deleteAction = new AbstractAction("Delete", ApplicationHelper
                    .getIcon(ApplicationHelper.icon_name_large_delete)) {
                private static final long serialVersionUID =
                        5483273497818329289L;

                public void actionPerformed(ActionEvent e) {
                    org.nanoboot.tasklibre.model.Action n =
                            actionSpinner.getSelectedAction();
                    if (n != null) {
                        n.setResolution(org.nanoboot.tasklibre.model.Action.Resolution.DELETED);
/*						if (noteTable.getRowCount()>0) {
							noteTable.getSelectionModel().setSelectionInterval(0, 0);
						}*/
                    }
    ...
    private Action getResolveAction() {
        if (resolveAction == null) {
            resolveAction = new AbstractAction("Resolve", ApplicationHelper
                    .getIcon(ApplicationHelper.icon_name_large_resolve)) {
                private static final long serialVersionUID = 1L;
                ...
                public void actionPerformed(ActionEvent e) {
                    org.nanoboot.tasklibre.model.Action n =
                            actionSpinner.getSelectedAction();
                    if (n != null) {
                        n.setResolution(org.nanoboot.tasklibre.model.Action.Resolution.RESOLVED);
						/*if (noteTable.getRowCount()>0) {
							noteTable.getSelectionModel().setSelectionInterval(0, 0);
						}*/
                    }
    ...
    private void checkSelection() {
        ...
        if (actionTable.getSelectedAction() == null
            && actionTable.getRowCount() > 0) {
    ...
    private void checkLeft() {
        leftLabel.setText(
                "Items to process: " + engine.getGTDModel().getInBucketFolder()
                        .getOpenCount());
    }
