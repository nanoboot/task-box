...
package org.nanoboot.gtdfree;

import com.formdev.flatlaf.FlatLightLaf;
import org.nanoboot.gtdfree.gui.ExecutePane;
import org.nanoboot.gtdfree.gui.ImportExampleDialog;
import org.nanoboot.gtdfree.gui.InBasketPane;
import org.nanoboot.gtdfree.gui.JournalPane;
import org.nanoboot.gtdfree.gui.OrganizePane;
import org.nanoboot.gtdfree.gui.ProcessPane;
import org.nanoboot.gtdfree.gui.QuickCollectPanel;
import org.nanoboot.gtdfree.model.ConsistencyException;
...
import org.nanoboot.gtdfree.model.GTDModelListener;
import org.nanoboot.gtdfree.model.Utils;
...
public class GTDFreeMain {
    ...
    public static void main(final String[] args) {
        ...
        System.out.println("java -jar gtd-free.jar [-data <folder>]");
        //                           1         2         3         4         5         6         7         8
        ...
        if (!ApplicationHelper.tryLock(f)) {
            System.out
                    .println("Instance of GTD-Free already running, exiting.");
            System.exit(0);
        }

        try {
            final GTDFreeMain application = new GTDFreeMain();
    ...
    private JFrame getJFrame() {
        if (jFrame == null) {
            ...
            jFrame.setTitle("GTD-Free" + windowTitleSuffix);
...
/*	private void restoreState() {
    ...
    private Component getOverviewPane() {
        if (overview == null) {
            ...
            sl = new SummaryLabel("mainCounts") {
                ...
                @Override
                public void actionPerformed(ActionEvent e) {
                    GTDFreeMain.this.getActionMap().get("importDialog")
                            .actionPerformed(e);
    ...
    private JMenu getHelpMenu() {
        if (helpMenu == null) {
            ...
            JMenuItem jmi = new JMenuItem("GTD-Free Home Page");
    ...
    private JDialog getAboutDialog() {
        if (aboutDialog == null) {
            ...
            aboutDialog.setTitle("About GTD-Free");
            ...
            JLabel jl = new JLabel("GTD-Free", ii, SwingConstants.CENTER);
    ...
    private JFileChooser getFileChooser() {
        if (fileChooser == null) {
            ...
            fileChooser.setFileFilter(
                    new FileNameExtensionFilter("GTD-Free XML file", "xml"));
        }
        return fileChooser;
    }
    ...
    class SummaryBean implements GTDModelListener {
        ...
        public void elementModified(
                org.nanoboot.gtdfree.model.ActionEvent a) {
            if (a.getAction().getFolder().isQueue() || a.getAction()
                ...
                updateInBucket();
                               ...
                               .equals(org.nanoboot.gtdfree.model.Action.REMIND_PROPERTY_NAME)
                       || (a.getAction().getRemind() != null && a.getProperty()
                    .equals(org.nanoboot.gtdfree.model.Action.RESOLUTION_PROPERTY_NAME))) {
                updateReminders();
            }
        }
        ...
        private void updateReminders() {
            ...
            for (org.nanoboot.gtdfree.model.Action a : getEngine()
