...
import org.nanoboot.gtdfree.gui.StateMachine;
import org.nanoboot.gtdfree.journal.JournalModel;
import org.nanoboot.gtdfree.model.ActionEvent;
...
public class GTDFreeEngine {
    ...
    public GTDFreeEngine() throws FileNotFoundException, XMLStreamException,
    ...
    private boolean handleFailedLoad(GTDModel m, GTDModel.DataHeader[] dh,
        ...
        if (dh == null || dh.length <= i) {
            ...
            int option = JOptionPane.showConfirmDialog(
                    ...
                    "GTD-Free - Error Loading Data File",
